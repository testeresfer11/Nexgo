        ...
        <div class="container" style="max-width: 500px; margin:0 auto">
            <table style="width: 100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <p style="font-size: 18px; color: #808080;">Please note, if there are further complaints about your rides, we may be forced to block your Nexgo account </p>

                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p style="margin-bottom: 40px;font-size: 18px; color: #808080;background-color: #f9f9f9; padding: 30px;">We strive to maintain a safe and secure Nexgo community for all our users</p>
                        </td>
                    </tr>
                      <tr>
