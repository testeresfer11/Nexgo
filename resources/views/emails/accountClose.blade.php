    ...
    <div class="welcome-email">
        <div class="container" style="max-width: 500px; margin:0 auto">
            <table style="width: 100%;">
                <thead>
                    <tr>
                        <th style="font-size: 40px;color: #7dbf43;text-align: left;font-weight: 600;">Nexgo</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td>
                            <p style="font-size: 18px; color: #808080;">We are sorry to see you go.We hope you join the Nexgo community again.</p>
                        </td>
                    </tr>
                      <tr>
